...
# Interfaces
$(call inherit-product, $(LOCAL_PATH)/hardware/interfaces.mk)
...
# Seccomp policy
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/media/seccomp/mediacodec.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediacodec.policy
